...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        self, input_ids: torch.LongTensor, model_kwargs, coref_info=None
    ) -> Dict[str, Any]:
        if "encoder_outputs" not in model_kwargs:
            ...
            if coref_info is not None:
                model_kwargs["encoder_outputs"]: ModelOutput = encoder(input_ids, return_dict=True, coref_information=coref_info, **encoder_kwargs)
            else:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs = self._prepare_encoder_decoder_kwargs_for_generation(input_ids, model_kwargs, coref_info)
